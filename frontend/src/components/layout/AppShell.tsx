...
export function AppShell({ title, children }: { title: string; children: ReactNode }) {
  ...
  return (
    <div className="min-h-[100dvh] bg-ink">
      ...
      {/* Top bar */}
      <header className="sticky top-0 z-30 flex min-h-14 items-center justify-between border-b border-line bg-ink/85 px-4 pt-[env(safe-area-inset-top)] backdrop-blur md:pl-[calc(15rem+1.5rem)] md:pr-6">
